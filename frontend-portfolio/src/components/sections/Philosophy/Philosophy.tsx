  ...
  const data = [
    {
      ...
      desc: "Performance is engineered from the first line of code. Every line of code is written with the critical rendering path in mind, ensuring sub-second load times and 60fps interactions.",
    ...
    },
    {
      ...
      desc: "Using modular architecture and type safety to build systems that scale predictably. I prefer boring, proven tech over hype, ensuring long-term maintainability.",
    ...
    },
    {
      ...
      desc: "Engineering decisions are guided by measurement, performance profiling, and iterative refinement. I use Node.js to bridge my frontend expertise into full-stack logic, focusing on robust API design.",
